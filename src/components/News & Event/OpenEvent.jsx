    ...
    <>
      <div className="px-4 lg:px-12.5 mt-6.5 md:mt-12.5">
        <div className="max-w-[1052px] mx-auto">
          ...
          <div className="flex max-sm:flex-wrap items-center gap-4 md:gap-12.5 mt-2.5">
            <div className="flex gap-2.5 items-center">
              <AdminIcon />
              <p className='font-semibold md:text-xl leading-8 text-black'>Admin</p>
            </div>
            <div className="flex gap-2.5 items-center">
              <TimeIcon />
              <p className='font-semibold md:text-xl leading-8 text-black'>September 4, 2025</p>
            </div>
            <div className="flex gap-2.5 items-center">
              <CommentIcon />
              <p className='font-semibold md:text-xl leading-8 text-black'>No Comment</p>
            </div>
          </div>
